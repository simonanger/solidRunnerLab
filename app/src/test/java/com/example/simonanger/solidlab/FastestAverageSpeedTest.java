 ...
 */
public class FastestAverageSpeedTest {

    FastestAverageSpeed fastestAverageSpeed;
    Athlete athlete1;
    Athlete athlete2;
    Run run1;
    Run run2;
    ...
    @Before
    public void before(){
        fastestAverageSpeed = new FastestAverageSpeed();
        ...
        fastestAverageSpeed.getRunners().add(athlete1);
        fastestAverageSpeed.getRunners().add(athlete2);
    }

    @Test
    public void testWinner() {
        assertEquals("Bolt" , fastestAverageSpeed.winner());
    }
